    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thanks for purchasing <strong>{productName}</strong>!
          </Text>
          {awaitingVerification && (
            <Text style={text}>
              Your order is currently awaiting verification. You will receive an
              email once your order has been verified.
            </Text>
          )}
